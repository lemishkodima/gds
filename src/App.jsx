...
const teamDoctors = [
  {
    ...
    paragraphs: [
      'Мене звати Юрій Петрович, я лікар-стоматолог-хірург, який спеціалізується на імплантації, тотальному відновленні зубів та кістковій пластиці.',
      'Моя спеціалізація — комплексне відновлення зубів у складних клінічних випадках. Разом із командою лікарів ми знаходимо рішення навіть тоді, коли пацієнту раніше говорили, що відновити зуби неможливо. Саме сучасні методики імплантації, цифрове планування та командний підхід дозволяють досягати прогнозованих і довговічних результатів.',
      'Моя мета — знайти рішення для кожного пацієнта, незалежно від складності ситуації, і досягти результату, який буде служити багато років.',
      'Буду радий стати вашим лікарем і допомогти повернути не лише зуби, а й звичну якість життя.',
    ],
  },
  {
    id: 'nazar-kemenyash',
    ...
    paragraphs: [
      'Вітаю!',
      'Мене звати Назар Михайлович, я лікар-стоматолог-гігієніст та пародонтолог.',
      "Спеціалізуюся на діагностиці, профілактиці та лікуванні захворювань ясен і тканин, що оточують зуби. Допомагаю пацієнтам зберегти здоров'я власних зубів, підготувати ясна до імплантації та забезпечити довготривалий результат після протезування на імплантах. Професійну гігієну проводжу за сучасним європейським протоколом із використанням системи Cavitron. Це забезпечує ретельне очищення зубів і поверхні імплантів, мінімізує дискомфорт під час процедури, сприяє швидшому відновленню ясен і є важливою умовою для довготривалого збереження власних зубів та імплантів.",
      'Переконаний, що здорові ясна — це фундамент красивої усмішки, успішної імплантації та довговічності ортопедичних конструкцій.',
      "Запрошую вас на консультацію. Разом ми оцінимо стан ваших ясен, визначимо оптимальний план лікування та допоможемо зберегти здоров'я вашої усмішки на довгі роки.",
    ],
  },
  {
    id: 'yurii-mshetsian',
    name: 'Мшецян Юрій',
    role: 'Лікар-стоматолог-хірург',
    focus: 'Видалення зубів будь-якої складності, імплантація та кісткова пластика',
    image: '/images/team/yurii-mshetsian.webp',
    imagePosition: 'center 28%',
    paragraphs: [
      'Вітаю!',
      'Мене звати Юрій, я лікар-стоматолог-хірург, який спеціалізується на видаленні зубів будь-якої складності, імплантації та кістковій пластиці.',
      'Багато пацієнтів приходять до мене з хвилюванням перед хірургічним лікуванням. Моє завдання — зробити так, щоб ви почувалися спокійно та впевнено на кожному етапі. Я працюю максимально делікатно, уважно й акуратно, адже знаю, наскільки важливі комфорт і довіра під час лікування.',
      'У своїй роботі використовую сучасні методики та цифрове планування, що дозволяють проводити хірургічні втручання максимально точно, прогнозовано та з мінімальною травматичністю. Це допомагає скоротити період відновлення та зробити лікування більш комфортним для пацієнта.',
      'Буду радий стати вашим лікарем і допомогти відновити зуби з максимальним комфортом, турботою та увагою до кожної деталі.',
    ],
  },
  {
    ...
    paragraphs: [
      'Вітаю!',
      "Мене звати Олександр Олександрович, я лікар-стоматолог-хірург. Спеціалізуюся на імплантації, кістковій пластиці та пластиці м'яких тканин (ясен).",
      'У хірургії я найбільше ціную точність, спокій і прогнозованість. Саме тому кожне лікування ретельно планую, продумую кожен етап і працюю максимально уважно до деталей. Переконаний, що якісний результат починається з правильної підготовки.',
      'Використовую сучасні хірургічні методики та цифрове планування, які дозволяють проводити втручання максимально точно, безпечно та з мінімальною травматичністю. Це забезпечує комфортне лікування та швидше відновлення.',
      'Для мене важливо, щоб навіть найскладніше хірургічне втручання проходило для пацієнта спокійно та впевнено. Саме тому я завжди пояснюю план лікування, відповідаю на всі запитання і залишаюся поруч на кожному етапі.',
      'Буду радий допомогти вам пройти лікування впевнено, спокійно та з результатом, у якому ви будете впевнені.',
    ],
  },
  {
    id: 'volodymyr-melnyk',
    ...
    paragraphs: [
      'Вітаю! Мене звати Володимир Олегович, я лікар-стоматолог-ортопед, який спеціалізується на відновленні втрачених зубів за допомогою сучасного протезування.',
      'Я допомагаю пацієнтам відновити зуби навіть у складних клінічних випадках — від встановлення коронок до комплексного відновлення зубів на імплантах при повній або частковій їх втраті.',
      'У своїй роботі я використовую сучасні цифрові технології та працюю в команді з хірургами-імплантологами, щоб кожен етап лікування був максимально точним, прогнозованим і комфортним для пацієнта.',
      'Запрошую вас на консультацію. Ми детально розглянемо вашу ситуацію, обговоримо всі можливі варіанти лікування та разом оберемо рішення, яке буде найкращим саме для вас.',
    ],
  },
  {
    ...
    imagePosition: 'center 22%',
    paragraphs: [
      'Мене звати Світлана Ігорівна, я лікар-ортодонт.',
      'Працюю з брекетами, елайнерами та іншими сучасними ортодонтичними системами, використовуючи цифрове планування лікування, 3D-сканування та моделювання майбутнього результату. Завдяки цьому пацієнт ще до початку лікування розуміє, яким буде його майбутня усмішка. Для мене важливо не лише вирівняти зуби, а створити умови, за яких кожен етап комплексного лікування буде максимально точним, прогнозованим і довговічним. Моя мета — створити правильний прикус, який забезпечить коректну роботу всієї зубощелепної системи. Саме це часто є вирішальним етапом перед імплантацією, протезуванням і комплексною реабілітацією.',
      'Буду рада допомогти вам зробити перший крок до здорової, функціональної та красивої усмішки, яка стане результатом злагодженої роботи всієї команди нашого Центру.',
    ],
  },
  {
    ...
    paragraphs: [
      'Вітаю!',
      'Мене звати Тарас Андрійович, я лікар-стоматолог-хірург, який спеціалізується на імплантації, видаленні зубів будь-якої складності, кістковій пластиці та комплексній хірургічній підготовці до протезування.',
      'У своїй роботі я керуюся трьома принципами — точність, послідовність і прогнозованість. Кожне лікування починається з ретельної діагностики та детального планування, адже саме це є основою успішного результату.',
      'Використовую сучасні цифрові технології та працюю за міжнародними протоколами, щоб кожен етап лікування був максимально точним, безпечним і комфортним для пацієнта.',
      'Я переконаний, що успішна імплантація — це не лише знання і майстерність хірурга, а й уважність до кожної деталі.',
      'Запрошую вас на консультацію. Разом ми детально проаналізуємо вашу клінічну ситуацію, складемо індивідуальний план лікування та оберемо оптимальне рішення для відновлення зубів.',
    ],
  },
]
        ...
        <section className="team-hero">
          <div className="container team-hero__inner">
            ...
            <div className="team-hero__facts" data-reveal="right">
              <div><strong>7</strong><span>лікарів у команді</span></div>
